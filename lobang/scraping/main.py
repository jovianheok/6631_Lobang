...
from lobang.scraping.database.insertion import save_raw_posts, save_parsed_deals
...
def main():
    try:
        ...
        rows = get_raw_posts()      # Retreive raw posts from database
        parsed_deals = [parse_raw_post(row) for row in rows]     # Parse raw posts
